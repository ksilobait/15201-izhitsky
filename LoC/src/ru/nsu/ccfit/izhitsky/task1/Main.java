...
public class Main
{
    public static void main(String[] args)
    {
		...
		*/
	    ...
	    //TEST
	    MyFilter f1 = MyComplexFilterFactory.toCreate(".java");
	    if(f1.toString().equals(".java"))
	    	System.out.println("TEST 3.1 COMPLETED");

	    MyFilter f2 = MyComplexFilterFactory.toCreate("<102345");
	    if(f2.toString().equals("<102345"))
		    System.out.println("TEST 3.2 COMPLETED");

	    MyFilter f3 = MyComplexFilterFactory.toCreate("!.java");
	    if(f3.toString().equals("!(.java)"))
		    System.out.println("TEST 3.3 COMPLETED");

	    MyFilter f4 = MyComplexFilterFactory.toCreate("|(<102345 !.java)");
	    if(f4.toString().equals("|(<102345 !(.java))"))
		    System.out.println("TEST 3.4 COMPLETED");

	    MyFilter f5 = MyComplexFilterFactory.toCreate("!(&(|(.java .txt) .jpg) .mp3)");
